...
from peer_atlas_cli.commands.refresh_program import refresh_program_cmd
from peer_atlas_cli.commands.refine_program import refine_program_cmd
from peer_atlas_cli.commands.reevaluate_categories import reevaluate_categories_cmd
...
main.add_command(refresh_program_cmd, "refresh-program")
main.add_command(refine_program_cmd, "refine-program")
main.add_command(reevaluate_categories_cmd, "reevaluate-categories")
